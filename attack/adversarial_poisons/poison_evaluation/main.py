...
# ######################################### ImageNet
# bs = 256
# train_dir = "/home/datasets/ILSVRC2012/train/"
# test_dir = "/home/datasets/ILSVRC2012/val/"
...
# ### 随机选取100个数据
# sample_num = 5000
# subdataset, _ = torch.utils.data.random_split(dataset, [sample_num, len(dataset)-sample_num], generator=torch.Generator().manual_seed(0))
# dataloader = DataLoader(dataset=subdataset, batch_size=bs, shuffle=False, num_workers=10)
